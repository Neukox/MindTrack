        ...
        <main className="max-w-4xl mx-auto px-4 py-10">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm p-6 md:p-8 transition-colors">
            ...
            <textarea
              ...
              className="w-full border border-rose-100 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-lg p-4 h-40 focus:outline-none focus:ring-2 focus:ring-rose-200 dark:focus:ring-blue-500 text-slate-700 dark:text-white transition-colors"
            />
