...
return (
    ...
    <div className="max-w-6xl mx-auto px-6">
        ...
        {cardData.map((card, index) => (
            <article key={index} className=" cursor-pointer flex items-start gap-4 p-8 bg-white rounded-xl shadow-sm border border-transparent hover:shadow-md transition">
