...
export default function NavBar({ title = "MindTrack - Dashboard" }: NavBarProps) {
      ...
      <nav className="bg-primary-gradient border-b border-gray-200 shadow-2xl">
        <div className="max-w-7xl px-2 sm:px-6 lg:px-8">
          <div className="flex items-center md:mx-10 h-16 w-full">
            ...
            {/* Logo Section */}
          <div className="flex items-center space-x-3 bg-indigo-100 h-13 w-14 pl-2 pr-2 rounded-2xl text-black font-sans font-bold text-xl
  ...
  <div className="flex flex-col">
    ...
    <p className="text-sm text-gray-500 flex whitespace-nowrap">
      Diário de Bordo Acadêmico
            ...
            {/* Nav Links (desktop) */}
            <nav aria-label="Primary navigation" className="hidden sm:flex flex-1 items-center space-x-6 mx-60">
              ...
              <div className="flex ml-80 whitespace-nowrap" aria-label="Actions">
              ...
              {/* User Profile Info */}
              <div className="border-r-2 border-gray-200 h-8" aria-hidden="true" />
              <div className="flex flex-col" role="group" aria-label="User profile">
                ...
                <span className="text-sm font-sans font-medium text-gray-500">davi.leal@example.com</span>
              </div>
