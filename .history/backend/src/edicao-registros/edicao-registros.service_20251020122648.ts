...
export class EdicaoRegistrosService {
  ...
  async deleteMultipleReflexoes(
    ...
    try {
      ...
      console.log('Excluindo múltiplas reflexões:', reflexaoIds, 'do usuário:', userId);
      ...
      const idsNaoEncontrados = reflexaoIds.filter(id => !idsEncontrados.includes(id));
      ...
      console.log('Reflexões excluídas:', resultado.count, 'Não encontradas:', idsNaoEncontrados);
  ...
  async updateMultipleReflexoes(
    ...
    try {
      ...
      console.log('Editando múltiplas reflexões:', reflexaoIds, 'do usuário:', userId);
      ...
      console.log('Reflexões atualizadas:', resultado.count, 'Não encontradas:', idsNaoEncontrados);
