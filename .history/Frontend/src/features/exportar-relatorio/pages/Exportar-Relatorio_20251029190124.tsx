...
export default function ExportReportPage() {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-primary-gradient dark:bg-linear-to-br dark:from-gray-900 dark:to-gray-800 text-gray-800 dark:text-white flex flex-col items-center p-4 sm:p-6 md:p-10 transition-colors duration-300">
        <div className="w-full max-w-6xl">
          ...
          <div className="mb-8 shadow-md bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 transition-colors">
            ...
            <div className="px-6 py-4">
              ...
              <div className="mb-4">
                ...
                <div className="flex flex-wrap gap-2">
                  <button
                    ...
                    className="px-3 py-1 text-xs bg-gray-100 dark:bg-gray-700 dark:text-white hover:bg-gray-200 dark:hover:bg-gray-600 rounded-md transition-colors"
                  >
                    Último mês
                  </button>
                  <button
                  ...
                  <button
                    ...
                    className="px-3 py-1 text-xs bg-blue-100 dark:bg-blue-800 hover:bg-blue-200 dark:hover:bg-blue-700 text-blue-700 dark:text-blue-200 rounded-md transition-colors border border-blue-300 dark:border-blue-600"
                  >
                    Todos os registros
                  </button>
                </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                <div className="flex flex-col">
                  ...
                  <div className="flex items-center border border-gray-300 dark:border-gray-600 rounded-lg p-2 bg-[#f8f4ef] dark:bg-gray-700">
                    <Calendar className="w-4 h-4 text-gray-500 dark:text-gray-400 mr-2" />
                    <input
                      type="date"
                      value={startDate}
                      onChange={(e) => setStartDate(e.target.value)}
                      className="bg-transparent w-full focus:outline-none text-gray-700 dark:text-white"
                    />
                  </div>
                </div>
              ...
              <div
                className={`p-3 rounded-lg text-center mb-4 transition-colors ${
                  totalRegistros > 0
                    ? "bg-[#eaf3ec] dark:bg-green-900/30 text-green-700 dark:text-green-400"
                    : "bg-[#fef3f3] dark:bg-red-900/30 text-red-700 dark:text-red-400"
                }`}
              >
                {isLoadingCount ? (
                  "Contando registros..."
          ...
          <div className="shadow-sm border border-[#f2e6da] dark:border-gray-600 bg-[#fdf3ee] dark:bg-gray-800/60 rounded-lg transition-colors">
            <div className="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
