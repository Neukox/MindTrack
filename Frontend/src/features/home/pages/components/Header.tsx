  ...
  return (
    <header className="flex justify-between items-center px-6 sm:px-10 lg:px-20 py-4 border-b border-gray-100">
      <div className="flex items-center space-x-2">
        <img src={MindTrackBlue} alt="MindTrack logo" className="w-10 h-10 sm:w-12 sm:h-12 object-contain" />
        <span className="text-xl sm:text-2xl font-semibold text-gray-800">MindTrack</span>
      </div>
