        ...
        <div className="max-w-7xl px-2 sm:px-6 lg:px-8">
          <div className="flex items-center md:mx-10 h-16 w-full">
            ...
            >
              ...
              <div
                ...
                aria-label="Actions"
              >
                <Button className="p-2 flex items-center gap-2" onClick={() => navigate('/novo-registro')}>
                  <FaPlus />
                  Novo Registro
                </Button>
              </div>
          ...
          {isOpen && (
            <div className="bg-[#EAE8E7] flex flex-col right-0 top-full shadow-lg p-3 pl-4 rounded-md space-y-3 sm:hidden text-right justify-between mt-2">
              ...
              <Button className="p-2 flex items-center gap-2 mt-2" onClick={() => navigate('/novo-registro')}>
                <FaPlus />
                Novo Registro
              </Button>
