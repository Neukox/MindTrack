...
export const getRegistrosSemanaAtual = async (): Promise<SemanaAtualResponse> => {
  try {
...
export const getEstatisticasSemanaAtual = async (): Promise<EstatisticasSemanaResponse> => {
  try {
    const token = localStorage.getItem("token");
