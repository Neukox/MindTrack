...
const variants = {
  ...
  minCard:
    "bg-white dark:bg-gray-800 rounded-2xl p-5 pt-4 shadow-xl w-full min-h-[7rem] transition-colors",
  mediumCard:
    ...
    <div className={`${variants[variant]} ${extraClass}`}>
      ...
      <div className="flex justify-between items-center">
        <div className="flex flex-col px-5 gap-2">
          <h2 className="text-xl font-extrabold text-gray-900 dark:text-white leading-tight tracking-tight">
            {title}
          </h2>
          {description && (
