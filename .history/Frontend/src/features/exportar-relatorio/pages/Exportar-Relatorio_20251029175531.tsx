...
export default function ExportReportPage() {
  ...
  const buscarTodosRegistros = async () => {
    try {
      ...
      console.log("🔍 Buscando todos os registros para verificar se há dados...");
      
      const response = await buscarRegistros(); // Sem filtros = todos os registros
      
      console.log("📊 Total de registros existentes:", response.data?.length || 0);
  ...
  useEffect(() => {
    ...
    console.log("🗓️ Definindo datas padrão:", params);
