...
import { editarRegistro, type EditarRegistroData } from "../../auth/api/axiosEditarRegistro";
  ...
  useEffect(() => {
    const carregarRegistro = async (registroId: string) => {
      try {
        ...
        // TODO: Implementar API para buscar registro específico
        ...
        const registroMock = {
          id: registroId,
          title: "Reflexão sobre a aula de React",
          content: "Hoje aprendi muito sobre hooks e estado...",
          category: "ESTUDO",
          emotion: "Alegria",
        };

        setTitulo(registroMock.title);
        setReflexao(registroMock.content);
        setCategoria(registroMock.category);
        setEmocao(registroMock.emotion);
      } catch (error) {
