...
import { buscarRegistros, type RegistroData } from "../../auth/api/axiosBuscarRegistros";
              ...
              <article key={r.id} className="bg-white rounded-xl p-6 shadow-sm">
                <div className="md:flex md:justify-between">
                  <div>
                    ...
                    <div className="text-sm text-slate-500 mt-1">{formatDate(r.createdAt)}</div>
                  </div>
                ...
                <div className="border-t border-rose-100 mt-4 pt-3 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                  <div className="flex items-center gap-3">
                    <span className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-rose-50 text-sm">
                      ...
                      <span className="font-medium">{getCategoryDisplay(r.category)}</span>
                    </span>

                    <span className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-rose-50 text-sm">
                      <span className="text-sm">🙂</span>
                      <span className="font-medium">{getEmotionDisplay(r.emotion)}</span>
                    </span>
                  </div>
