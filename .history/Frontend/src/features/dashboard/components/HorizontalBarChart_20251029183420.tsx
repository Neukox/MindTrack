...
export default function GraficoEmocoes() {
  ...
  const emotionColors = [
    "#FF6B6B", // Vermelho vibrante para ansiedade/tristeza
    "#4ECDC4", // Verde água para calma
    "#45B7D1", // Azul para reflexão  
    "#96CEB4", // Verde claro para alegria
    "#FECA57", // Amarelo para motivação
    "#FF9FF3", // Rosa para outras emoções
  ];
