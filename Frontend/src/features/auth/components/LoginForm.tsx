    ...
    <>
      ...
      <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50 dark:bg-gray-900 p-6 transition-colors">
        ...
        >
          ...
          {/* Campo de senha */}
          <label className="block text-slate-700 dark:text-gray-300 text-sm mb-1 transition-colors">
            Senha
          </label>
          ...
          <div className="text-center mt-4">
            <span className="text-sm text-slate-500 dark:text-gray-400 transition-colors">
              Não tem uma conta?{" "}
            </span>
            <Link
              to="/cadastro"
