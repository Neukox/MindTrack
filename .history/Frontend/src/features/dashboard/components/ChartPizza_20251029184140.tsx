...
export default function ChartPizza() {
  ...
  const fillColor = "#a78bfa";  const renderCustomizedLabel = (props: unknown): React.ReactNode => {
    ...
    return (
      ...
      >
        <tspan fill="#1f2937" className="dark:fill-white">
          {`${item.name}`}
        </tspan>
        <tspan x={x} dy="16" fill="#6b7280" className="dark:fill-gray-300" fontSize="12" fontWeight="600">
