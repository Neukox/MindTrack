      ...
      <div className="w-full max-w-6xl">
        ...
        <div className="mb-8 shadow-md bg-white rounded-lg border border-gray-200">
          <div className="px-6 py-4 border-b border-gray-200">
            <h3 className="text-lg sm:text-xl font-semibold">Gerar Relatório em PDF</h3>
        ...
        <div className="shadow-sm border border-[#f2e6da] bg-[#fdf3ee] rounded-lg">
          <div className="px-6 py-4 border-b border-gray-200">
            <h3 className="text-lg font-semibold text-gray-800">O que está incluído no relatório?</h3>
          </div>
          <div className="px-6 py-4">
