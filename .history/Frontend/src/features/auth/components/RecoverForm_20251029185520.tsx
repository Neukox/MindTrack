    ...
    <>
      ...
      <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50 dark:bg-gray-900 p-6 transition-colors">
        ...
        >
          ...
          {/* Email */}
          <label className="block text-slate-700 dark:text-gray-300 text-sm mb-1 transition-colors" htmlFor="email">
            Email
          </label>
          <input
            id="email"
          ...
          <div className="text-center mt-4">
            <Link to="/" className="text-sm text-blue-600 dark:text-blue-400 hover:underline transition-colors">
              ⭠ Voltar para login
            </Link>
          </div>
        </form>
