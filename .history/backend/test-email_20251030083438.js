...
async function testEmailConfig() {
  ...
  try {
    ...
    console.log('📧 Você quer testar o envio de email? (pressione Ctrl+C para cancelar)');
    setTimeout(async () => {
      try {
    ...
    console.error('1. Verifique se EMAIL_PASS é a senha de app do Gmail (16 caracteres)');
