...
export default function MindTrackRecords() {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-primary-gradient dark:bg-gradient-to-br dark:from-gray-900 dark:to-gray-800 text-slate-800 dark:text-white transition-colors duration-300">
        {/* Page content */}
        <main className="max-w-6xl mx-auto px-4 py-10">
          <Link
            to="/dashboard"
            className="text-blue-600 dark:text-blue-400 font-bold text-sm mb-3 flex items-center gap-1 outline-none hover:text-blue-700 dark:hover:text-blue-300 transition-colors"
          >
            <FaArrowLeft className="w-4 h-4" />
            <span className="text-sm">Voltar</span>
          </Link>
          <h1 className="text-3xl font-extrabold mb-1 text-slate-800 dark:text-white">Meus Registros</h1>
          ...
          {/* Filters card */}
          <section className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-4 md:p-6 mb-6 transition-colors">
            <div className="flex flex-col md:flex-row gap-4 md:items-center">
              <div className="flex-1">
                ...
                <input
                  ...
                  className="w-full border border-rose-100 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-rose-200 dark:focus:ring-blue-500 transition-colors"
                />
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 w-full md:w-auto">
                <select
                  ...
                  className="rounded-lg border border-rose-100 dark:border-gray-600 dark:bg-gray-700 dark:text-white px-3 py-2 transition-colors"
                >
                  <option>Todas</option>
          ...
          <section className="space-y-4">
            {loading ? (
              <div className="bg-white dark:bg-gray-800 rounded-xl p-8 text-center transition-colors">
                <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-blue-600 mx-auto mb-4"></div>
                <p className="text-slate-600 dark:text-gray-300">Carregando registros...</p>
              </div>
            ) : filtered.length === 0 ? (
              <div className="bg-white dark:bg-gray-800 rounded-xl p-8 text-center transition-colors">
                ...
                {records.length === 0 && (
                  <Link
                    to="/novo-registro"
                    className="inline-block mt-4 bg-blue-600 dark:bg-blue-500 text-white px-6 py-2 rounded-lg hover:bg-blue-700 dark:hover:bg-blue-600 transition"
                  >
              ...
              filtered.map((r) => (
                ...
                >
                  <div className="md:flex md:justify-between">
                    <div>
                      <h2 className="text-lg font-semibold text-slate-800 dark:text-white">{r.title}</h2>
                    ...
                    <div className="flex items-start gap-3 mt-4 md:mt-0">
                      <Link
                        ...
                        className="p-2 rounded-full hover:bg-rose-50 dark:hover:bg-gray-700 inline-block transition-colors"
                      >
                        <svg
                      ...
                      <button
                        ...
                        className="p-2 rounded-full hover:bg-rose-50 dark:hover:bg-gray-700 transition-colors"
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                  ...
                  <p className="mt-4 text-slate-700 dark:text-gray-300">{r.content}</p>

                  <div className="border-t border-rose-100 dark:border-gray-600 mt-4 pt-3 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                    <div className="flex items-center gap-3">
                      <span className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-rose-50 dark:bg-gray-700 text-sm dark:text-gray-300">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                    ...
                    <Link
                      to={`/ver-mais/${r.id}`}
                      className="text-sm text-sky-600 dark:text-sky-400 hover:underline self-end transition-colors"
                    >
                      Ver mais
                    </Link>
                  </div>
