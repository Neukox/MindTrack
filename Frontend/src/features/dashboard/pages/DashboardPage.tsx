      ...
      <div className="min-h-screen flex flex-col bg-gray-50 dark:bg-gray-900 pt-6 px-4 sm:px-6 lg:px-16 overflow-x-hidden transition-colors">
        ...
        <div className="mt-6 flex flex-col lg:flex-row gap-4 w-full overflow-hidden">
          <Cards
            ...
            description="Comparação entre esta semana e a anterior"
            chart={<Barchat />}
            className="flex-1 min-w-0 transition-all duration-300 hover:shadow-xl hover:shadow-indigo-100"
          />

          <Cards
            variant="mediumCard"
            title="🎯 Categorias Mais Usadas"
            description="Distribuição percentual dos seus registros"
            chart={<ChartPizza />}
            className="flex-1 min-w-0 transition-all duration-300 hover:shadow-xl hover:shadow-purple-100"
          />
        </div>
        ...
        <div className="mt-4 mb-6 w-full overflow-hidden">
          <Cards
            ...
            description="Análise das emoções mais presentes em suas reflexões"
            chart={<HorizontalBarChart />}
            className="min-w-0 transition-all duration-300 hover:shadow-xl hover:shadow-green-100"
          />
        </div>
      </div>
    </>
