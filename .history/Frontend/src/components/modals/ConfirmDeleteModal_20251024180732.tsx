      ...
      <div className="bg-white rounded-2xl shadow-xl max-w-md w-full mx-4 transform transition-all">
        ...
        <div className="flex items-center justify-between p-6 pb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-lg font-semibold text-slate-800">Excluir Registro</h3>
        ...
        <div className="px-6 pb-6">
          ...
          <div className="mb-6">
            <p className="text-sm text-slate-600 mb-3">
              Para confirmar, digite <span className="font-semibold text-red-600">EXCLUIR</span> no campo abaixo:
            </p>
            <input
              type="text"
              value={confirmText}
