    ...
    try {
      ...
      this.transporter = createTransport({
        ...
        tls: {
          ...
          // Remover ciphers: 'SSLv3' que causa erro de versão SSL
        },
        connectionTimeout: 60000, // 60 seconds (aumentado)
        greetingTimeout: 30000, // 30 seconds (aumentado)
        socketTimeout: 60000, // 60 seconds (aumentado)
        pool: true,
        maxConnections: 5,
        maxMessages: 100,
