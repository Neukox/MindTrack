...
export default function MindTrackRecords() {
  ...
  const carregarRegistros = async () => {
    try {
      ...
      console.log("Registros carregados:", response.data);
        ...
        <main className="max-w-6xl mx-auto px-4 py-10">
          ...
          <section className="space-y-4">
            {loading ? (
              ...
              filtered.map((r) => {
                console.log("Renderizando registro:", r);
                return (
                <article
                  key={r.id}
                ...
                >
                  <div className="md:flex md:justify-between">
                    ...
                    <div className="flex items-start gap-3 mt-4 md:mt-0">
                      <Link
                        ...
                        onClick={() => console.log("Navegando para editar:", r.id)}
                      >
                        <svg
                  ...
                  <div className="border-t border-rose-100 mt-4 pt-3 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                    ...
                    <Link
                      ...
                      onClick={() => console.log("Navegando para ver mais:", r.id)}
                    >
                      Ver mais
                    </Link>
                  </div>
